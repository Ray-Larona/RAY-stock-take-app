function uploadStockTake(){
  ...
  // 🔒 I-lock ang buong screen habang nagpapadala sa Google Sheets
  toggleLockScreen(true, "Uploading stock take, please wait...");
  ...
  .finally(()=>{
    // 🔓 Tanggalin ang screen lock at ibalik ang button kapag tapos na (success man o error)
